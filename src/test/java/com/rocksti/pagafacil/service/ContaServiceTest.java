...
class ContaServiceTest {
    ...
    void atualizarContaComErro() {
        ...
        NotFoundException exception = assertThrows(NotFoundException.class, () -> contaService.atualizarConta(1L, contaRequest));
    ...
    void alterarSituacaoContaComErro() {
        ...
        NotFoundException exception = assertThrows(NotFoundException.class, () -> contaService.alterarSituacaoConta(1L, SituacaoConta.PAGO));
    ...
    void buscarContaPorIdComErro() {
        ...
        NotFoundException exception = assertThrows(NotFoundException.class, () -> contaService.buscarContaPorId(1L));
    ...
    void testarImportarContas() throws IOException {
        ...
        List<ContaEntity> contaEntities = contaService.importarContas(getArquivoCsv());
    ...
    void testarImportarContasComErro() throws IOException {
        MultipartFile fileCsv = Mockito.mock(MultipartFile.class);
        when(fileCsv.getInputStream()).thenThrow(new IOException("Erro"));

        BadRequestException exception = assertThrows(BadRequestException.class, () -> contaService.importarContas(fileCsv));

        assertEquals("Erro ao importar CSV", exception.getMessage());
    }

    private MockMultipartFile getArquivoCsv() throws IOException {
